...
![Equation 1: r_t = \frac{P_t}{P_{t-1}} - 1](equations/part1_01.png)
...
The [repository instructions](https://github.com/rwuebker/left-tail-volatility/blob/main/README.md#prepare-the-data-and-run-part-1) describe Python 3.11.14, locked dependencies, data preparation, tests, and the [Part 1 notebook](https://github.com/rwuebker/left-tail-volatility/blob/main/notebooks/01_garch_foundations.ipynb). After environment setup, run these from the project root:
...
[Series guide](https://github.com/rwuebker/left-tail-volatility/blob/main/article/SERIES.md) · Next: Defining and forecasting downside risk (in preparation)
